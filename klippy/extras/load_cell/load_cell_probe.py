...
import math
from klippy import configfile, gcode, mcu
from klippy.extras import homing, probe
from . import sos_filter, hx71x, ads1220
...
class LoadCellProbeCommands:
    ...
    def cmd_LOAD_CELL_TEST_TAP(self, gcmd: gcode.GCodeCommand):
...
class LoadCellPrinterProbe:
    def __init__(self, config: configfile.ConfigWrapper):
        ...
        printer_probe = probe.PrinterProbe(config, wrapper)
