...
Your python plugins can now extend [`klippy/extras`](https://github.com/KalicoCrew/kalico/tree/master/klippy/extras) adding new modules to Kalico without causing updates to fail due to a "dirty" git tree.
