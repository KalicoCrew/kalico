// ADC functions on GD32F30x
// GD32F30x ADC is register-compatible with STM32F103 ADC.
//
//
...
static const uint8_t adc_pins[] = {
    ...
    ADC_TEMPERATURE_PIN, // GD32F30x channel 16 = temperature sensor
};

// GD32F30x: software-triggered conversion, enable temp/vref
...
{
    // GD32F30x requires calibration (same as STM32F103)
...
gpio_adc_setup(uint32_t pin)
{
    ...
    // GD32F30x has ADC0 and ADC1, use ADC0 (= STM32 ADC1)
