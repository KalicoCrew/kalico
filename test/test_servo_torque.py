...
def test_servo_pass_fires_on_axis_delta_only():
    ...
    assert th._fire_active_callbacks(5.0, 0.0, 0.0, 0.0) is False
    assert fired == []
    assert th._fire_active_callbacks(0.0, 3.0, 0.0, 0.0) is True
    assert fired == [42.0]
    assert th._fire_active_callbacks(0.0, 3.0, 0.0, 0.0) is False
    assert fired == [42.0]
