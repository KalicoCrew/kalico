...
Full hardware + flashing-window details: [`docs/kalico-rewrite/hardware.md`](../../../docs/kalico-rewrite/hardware.md).
...
What it does (matches the procedure in `hardware.md`): pull + checkout `<branch>` on
