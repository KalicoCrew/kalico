...
fn main() {
    ...
    // Compute the division in build.rs so the generated constant is a
    // pre-evaluated literal — the `integer_division` lint fires on raw
    // integer division expressions in source, not on literal values.
    ...
    let sizing_body = format!(
        "// Auto-generated by runtime/build.rs — do not edit.\n\
         ...
         /// Formula: PIECE_RING_SIZE / 32 (each `PieceEntry` is 32 bytes).\n\
         #[allow(clippy::unreadable_literal)]\n\
